                        ...
                        <div className="services__content_grid">
                            <div className="card">
                                ...
                                <motion.button className="card_button" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: [0.65, 0.05, 0.36, 1] }}>
                                    <a href="/services/information-systems">Read more</a>
                                </motion.button>
                            </div>
                            <div className="card">
                                ...
                                <motion.button className="card_button" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: [0.65, 0.05, 0.36, 1] }}>
                                    <a href="/services/business-process-re-engineering">Read more</a>
                                </motion.button>
                            </div>
                            <div className="card">
                                ...
                                <motion.button className="card_button" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: [0.65, 0.05, 0.36, 1] }}>
                                    <a href="/services/e-business">Read more</a>
                                </motion.button>
                            </div>
                            <div className="card">
                                ...
                                <motion.button className="card_button" whileHover={{ scale: 1.05 }} transition={{ duration: 0.4, ease: [0.65, 0.05, 0.36, 1] }}>
                                    <a href="/services/brand-designing-and-digital-marketing">Read more</a>
                                </motion.button>
                            </div>
                        </div>
