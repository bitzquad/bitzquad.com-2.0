...
const getById = async (id: string, select: any = {}, loadingCallback: (loading: boolean) => void, options: any = {}): Promise<CUser | null> => {
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users?${queryparser.Build({ _id: id }, select)}`;
...
const getAll = async (
    ...
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users?${queryparser.Build({}, select)}&count=${count}&countonly=${countonly}`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
        response = await axios.get(url, options);
...
const get = async (
    ...
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users?${queryparser.Build(search, select, items, page, sort)}&count=${count}&countonly=${countonly}`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
        response = await axios.get(url, options);
...
const create = async (user: CUser, draft: boolean = false, loadingCallback: (loading: boolean) => void, options: any = {}): Promise<CUser | null> => {
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users?draft=${draft}`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
...
const updateProps = async (search: any = {}, job: CUser, draft: boolean = false, loadingCallback: (loading: boolean) => void, options: any = {}): Promise<CUser | null> => {
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users?${queryparser.Build(search)}&draft=${draft}`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
...
const getMyInfo = async (loadingCallback: (loading: boolean) => void): Promise<CUser | null> => {
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/auth/myinfo`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
...
const get_Public = async (
    ...
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users/public?${queryparser.Build(search, select, items, page, sort)}&count=${count}&countonly=${countonly}`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
        response = await axios.get(url, options);
...
const getById_Public = async (id: string, select: any = {}, loadingCallback: (loading: boolean) => void): Promise<CUser | null> => {
    const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/users/public?${queryparser.Build({ _id: id }, select)}`;
    loadingCallback(true); // set loading callback of parent function to 'true'
    let response = null;
    try {
        response = await axios.get(url);
