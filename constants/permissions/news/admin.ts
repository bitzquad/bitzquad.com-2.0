...
createPermission.immutableprops = ["_id", "featured", "owner", "deleted", "draft"]; // Define the properties that can't be updated by 'Admin' role
...
readPermission.immutableprops = ["_id", "featured", "owner", "deleted", "draft"]; // Define the properties that can't be updated by 'Admin' role
...
updatePermission.immutableprops = ["_id", "featured", "owner", "deleted", "draft"]; // Define the properties that can't be updated by 'Admin' role
