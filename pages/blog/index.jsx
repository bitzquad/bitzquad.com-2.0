                            ...
                            <Link href={`/blog/${slug}`}>
                                <div key={index} className="blog_card group lg:hidden">
                                    ...
                                    <div className="blog_card_content">
                                        ...
                                        <p className="paragraph max-h-20 overflow-hidden text-ellipsis whitespace-pre-wrap" style={{ display: "-webkit-box", "-webkit-box-orient": "vertical", "-webkit-line-clamp": "3" }}>
                                            {blog.excerpt}
                                        </p>
                                        <div className="writer">
                                            <div className="image">
                        ...
                        <Link key={index} href={`/blog/${slug}`}>
                            <div key={index} className="blog_card group">
                                ...
                                <div className="blog_card_content">
                                    ...
                                    <p className="paragraph max-h-20 overflow-hidden text-ellipsis whitespace-pre-wrap lg:text-clip" style={{ display: "-webkit-box", "-webkit-box-orient": "vertical", "-webkit-line-clamp": "3" }}>
                                        {blog.excerpt}
                                    </p>
                                    <div className="writer">
                                        <div className="image">
