...
const Index = () => {
  ...
  return (
    <>
      <LayoutSubPages>
        <Meta
          title="Bitzquad | E-Business"
          description="Bitzquad provides bespoke E-Business models covering all your functions to achieve an optimal output. Save time and energy and invest in better growth with Bitzquad. Our competent team is ready to take you through an unmatchable journey."
        />
          ...
          <div className="mx-auto">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-6 text-lg italic leading-8 text-gray-600">
                &quot;Are you a futuristic organization which strives to achieve
                optimal efficiency in your business functions? The E-Business
                model is the best solution for you.&quot;
              </p>
            </div>
            <div className="mx-auto">
              <p className="mt-6 text-lg leading-8 text-gray-600">
                E-Business utilizes digital information and advanced
                communication technologies to streamline different business
                processes. It is an integration of the whole business over a
                computer mediated network. It replaces many manual systems and
                automates interconnected operations.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Bitzquad provides bespoke E-Business models covering all your
                functions to achieve an optimal output. Save time and energy and
                invest in better growth with Bitzquad. Our competent team is
                ready to take you through an unmatchable journey.
              </p>
            </div>
            ...
            <div className="lg:my-15 mx-auto  mt-8 max-w-2xl sm:mt-20 lg:max-w-none">
              <h2 className="pb-6 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl  lg:pb-8">
                Our Approach
              </h2>
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-8 lg:max-w-none lg:grid-cols-2">
                {features.map((feature) => (
                  <div
                    key={feature.name}
                    className="flex flex-col rounded-xl bg-white p-5 duration-200 ease-in hover:scale-105 "
                  >
            ...
            <div className="mx-auto mb-16 mt-8 max-w-2xl overflow-hidden sm:mt-20 lg:mt-15 lg:max-w-none">
              <h2 className="pb-6 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl lg:pb-8">
                Our Tech Stack
              </h2>
              <div className="marquee mx-auto flex max-w-lg items-center  gap-x-16 gap-y-10  sm:max-w-xl lg:mx-0 lg:max-w-none">
                ...
                <img
                  ...
                  src="/assets/img/techstack/nextjs.png"
                  alt="NextJS"
                  width={200}
                  height={113}
                />
                <img
                  className=" max-h-20 w-full object-contain "
                  src="/assets/img/techstack/vercel.png"
                  alt="Vercel"
                  width={200}
                  height={113}
                />
                ...
                <img
                  className=" max-h-20 w-full object-contain "
                  src="/assets/img/techstack/js.png"
                  alt="JS"
                  width={200}
                  height={113}
                />
                <img
                  className=" max-h-20 w-full object-contain "
                  src="/assets/img/techstack/tailwind.png"
                  alt="Tailwind"
                  width={200}
                  height={113}
                />
                <img
                  className=" max-h-20 w-full object-contain "
                  src="/assets/img/techstack/figma.png"
                  alt="Figma"
                  width={200}
                  height={113}
                />
                <img
                  className=" max-h-20 w-full object-contain "
                  src="/assets/img/techstack/aws.png"
                  alt="AWS"
                  width={200}
                  height={113}
                />
