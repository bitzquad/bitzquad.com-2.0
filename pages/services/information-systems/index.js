...
const Index = () => {
    ...
    return (
        <>
            <LayoutSubPages>
                <Meta title="Bitzquad | Information Systems" description="" />
                <div className="bz-container relative mx-auto mt-0 h-full w-full bg-transparent lg:mt-44">
                    <div className="mx-auto max-w-7xl">
                        <div className="mx-auto max-w-2xl lg:mx-0">
                            <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Information Systems</h1>
                        ...
                        <div className="mx-auto mt-8 max-w-2xl sm:mt-20 lg:mt-10 lg:max-w-none">
                            ...
                            <img src="/services-exp.webp" alt="App screenshot" className="mx-auto rounded-xl shadow-2xl ring-1 ring-white/10 lg:max-w-3xl" width={2432} height={1442} />
                        </div>
                        <div className="mx-auto mt-8  max-w-2xl sm:mt-20 lg:mt-10 lg:max-w-none">
                        ...
                        <div className="mx-auto mb-16 mt-8 max-w-2xl overflow-hidden sm:mt-20 lg:mt-10 lg:max-w-none">
                            ...
                            <div className="marquee mx-auto flex max-w-lg items-center  gap-x-8 gap-y-10  sm:max-w-xl lg:mx-0 lg:max-w-none">
                        ...
                        <div className="mx-auto mb-16 mt-8 max-w-2xl sm:mt-20 lg:mt-10 lg:max-w-none">
                            <h4 className="sm:text-1xl text-xl font-bold tracking-tight text-gray-900 ">Is this your next step to grow your business?</h4>
                            <p className=" text-lg leading-8 text-gray-600">Contact us to know more!</p>
                        </div>
                    </div>
                </div>
            </LayoutSubPages>
